...
from app.crud.viajes_helpers import (
    _generate_next_viaje_folio,
    _get_ultimo_evento_operativo_por_tipo,
    _get_ultimo_evento_standby_relacionado,
    _obtener_ultimo_kilometraje_por_trailer_en_viaje,
    _validar_kilometraje_monotonico_por_trailer,
    _validar_payload_operativo_por_accion,
    _viaje_listo_para_reinicio,
    _viaje_tiene_evento_operativo,
